...
dll_path = os.path.join(toolpath, "Scripts")
...
for metric in burn_metrics:
  ...
  z_table = ZonalStatisticsAsTable(classified, "JOIN", shift, outTable, "NODATA", "MAXIMUM")
  arcpy.AddField_management(outTable, metric, "INTEGER")
  arcpy.CalculateField_management(outTable, metric, "int([MAX])")
  one_to_one_join(classified, outTable, metric, "INTEGER")
  #-----------------------------------------------
  #-----------------------------------------------
