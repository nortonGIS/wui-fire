...
def fuelComplex(svm_fc, model, projection, unit):
    land_cover = sms_fc
...
# Create .LCP
#
fuel_asc = os.path.join(outputs, "fuel.asc")
canopy_asc = os.path.join(outputs, "canopy.asc")
stand_asc = os.path.join(outputs, "stand.asc")
slope_asc = os.path.join(outputs, "slope.asc")
elevation_asc = os.path.join(outputs, "elevation.asc")
aspect_asc = os.path.join(outputs, "aspect.asc")
projection_file = os.path.join(outputs, "fuel.prj")

landscape_file = os.path.join(outputs, "created.LCP")

createLCP(fuel_asc, "Class", canopy_asc, "Percent", stand_asc, unit, slope_asc, "Degrees", elevation_asc, unit, aspect_asc, "Degrees", projection_file)

#-----------------------------------------------
#-----------------------------------------------
text = "Landscape File created."
generateMessage(text)
#-----------------------------------------------
